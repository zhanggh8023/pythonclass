...
def JGHG_insert_data(table):
    ...
    for i in range(1,60000):
        ...
        #插入数据格式（修改内容）
        table_data =[( '313340' + str(ii),'C0151V23366170' + str(ii), '99166' + str(ii),'杭州银行股份有限公司西湖支行','手机银行APP'+str(i),'JRGJ098'+str(ii),'债券','RNB','杭州银行留下支行'+str(i),'3133' + str(ii),'CN', '中国银行'+str(ii),'A++','国际信用','中央','银行','0.3'+str(ii),'68749',20180321,20180606,20180606,20280606,'浮动','Y',468713,20181230,6541635,20181230)]
