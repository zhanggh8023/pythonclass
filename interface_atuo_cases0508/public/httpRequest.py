    ...
    def httpGet (self, url, method, data, sql, env):
        ...
        if 'env' in env.keys() and env['env'] == 1:
            if 'stationId' in env.keys():
                headers = set_user_token(stationId='HL99997', db=2)
            else:
...
if __name__ == '__main__':
    # data = {"age":18,"birthday":"1998-01-01","bookingName":"接口测试","bookingPhone":"15258814180","cardId":"330184199805016406","cardType":1,"couponFee":1000100,"couponInfo":[{"id": "a123","type": "discount","fee":1000100}] ,"marriageStatus":2,"medicalTime":"2021-02-05","name":"zgh","orgId":"HL99998","orgName":"杭州-禾连内网测试医院98","packageId":"2817","packageName":"未婚套餐测试","phone":"15258814180","profitsharing":1,"reportAddress":"邮件纸质报告地址","reportReceiver":"邮件纸质报告收件人","reportType":1,"sex":2,"time":"","usedCoupon":1,"userId":"zgh001"}
    # data = {"couponFee":1000100,"couponInfo":[{"id": "a123","type": "discount","fee":1000100}] ,"fee":1,"orderCountPrice":1000000,"orderId":"2536","payId":"11111111","receiptNo":"2536","usedCoupon":1,"userId":"zgh001"}
    # data = {"orderId": "2535", "userId": "zgh001"}
    ...
    data = {"stationId": "HL99997", "batchId": 4474}
    ...
    url = 'http://management-fed-gray.helianhealth.com/env-b2h/healthmanage-hospital/admin/card/v3/batch/branch/get'
    ...
    # url = 'http://b2htest.helianhealth.com/healthmanage-web/tencent/package/detail'
